        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    <h4 class="breadcrumb-title">Add New Post</h4>
                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="form-container">
                            <form action="PostController" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="category" name="category" required>
                                        ...
                                        <c:forEach var="category" items="${requestScope.categories}">
                                            <option value="${category.postCategoryID}">${category.postCategoryName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>
                                        <input type="checkbox" name="feature" value="true"> Feature Post
                                    </label>
                                </div>
